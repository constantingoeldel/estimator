...
parallel --jobs 26 --retries 1 --lb  R --file=run.R --no-save --no-echo --no-restore --args  ::: gene upstream downstream  ::: {0..1} > /home/constantin/estimator/alphabeta_test_stdout.txt 2> /home/constantin/estimator/alphabeta_test_stderr.txt 
